...
path1 =r"C:\Users\hp\Desktop\priyasoftweb\person_tracker_id_frame_time\input\example_01.mp4"
path3 =r"C:\Users\hp\Desktop\priyasoftweb\person_tracker_id_frame_time\input\store_camv1.mp4"
        ...
        # to determine direction
            ...
            if not to.counted:
                ...
                if direction < 0 and centroid[1] < H // 2:
                    ...
                    #id up with date--------------------
                    print("totalUp_objectID", objectID)
                    totalUp_id.append(objectID)
                    up_id_date[objectID]=time.strftime("%c")
                ...
                # center line, count the object
                    ...
                    #id down with date-------------------
                    print("totalDown_objectID", objectID)
                    totalDown_id.append(objectID)
                    down_id_date[objectID]=time.strftime("%c")
...
# =============================================================================
            ...
            #first frame age and gender attch to tracker----------------
            print("{}-{}-{}".format(objectID, prezic_gender, frames_count))
            gender_id_dict[objectID]=prezic_gender
            age_id_dict[objectID]=prezic_age
            
            if objectID not in object_id_list_gender:
                object_id_list_gender.append(objectID)
            ...
            print("age_id:", age_id)
            age_gen_text = "{}|{}".format(age_id[objectID], gender_id[objectID])
            cv2.putText(frame, age_gen_text, (x1, y1-20), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 255), 1)

    ...
    if ret:
        ...
        for (objectID, bbox) in objects.items():
            ...
            if input_im is None:
                ...
                #id_gen =dict()
                #gen=[]
                #id_gen[objectID]=prezic_gender
                #gen.append(prezic_gender)
                #print("id_gen", id_gen)
                #print("gen", gen)
                
                print("{}:{}".format(objectID, prezic_gender))
                gender_id[objectID]=prezic_gender
                
                age_id[objectID]=label

                age_gender_id[objectID]=[prezic_gender, label]
...
print("total frames_count:", frames_count)
cap.release()
out.release()

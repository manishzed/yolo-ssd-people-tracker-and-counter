...
def show_results(resultImg,frame, faceBoxes, model_age, model_gender,out_, padding=20):
    ...
    for (objectId, bbox) in objects.items():
        ...
        if(model_age!=None):
            ...
            cv2.putText(resultImg, label, (x11,y11-30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.9, (0,0,250));
        ...
        if(model_gender!=None):
            ...
            cv2.putText(resultImg, lines_gender[cls_gender_keras], (x11,y11-10), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.9, (0,0,250));
...
def main():
    ...
    out_ = cv2.VideoWriter("out_face_track(caffe)_age_gender(squeeznet)_v3.2.mp4", fourcc_codec, fps, capture_size)

...
def main():
    ...
    MODEL_ROOT_PATH=r"E:\softweb\Pretrained_model\face_age_gender_model\yolov2_tiny-face.h5"

    #Load Model
    model_face = load_model(MODEL_ROOT_PATH)
...
# =============================================================================
    ...
    out = cv2.VideoWriter("out_only_yolov2_face_age-gender_v1.avi", fourcc_codec, fps, capture_size)

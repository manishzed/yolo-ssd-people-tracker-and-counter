...
ubi_path3=r"C:\Users\hp\Desktop\priyasoftweb\UBI-IOT\ubi\8_2021-05-26_14-30-47.mp4"

ubi_path4 = r"C:\Users\hp\Desktop\priyasoftweb\UBI-IOT\ubi\8_2021-05-26_14-28-48.mp4"
ubi_path5=r"C:\Users\hp\Desktop\priyasoftweb\UBI-IOT\ubi\8_2021-05-26_14-28-33.mp4"

ubi_path6=r"C:\Users\hp\Desktop\priyasoftweb\UBI-IOT\ubi\7_2021-05-26_14-36-32.mp4"
ubi_path7=r"C:\Users\hp\Desktop\priyasoftweb\UBI-IOT\ubi\7_2021-05-26_14-35-16.mp4"

ubi_path01=r"C:\Users\hp\Desktop\priyasoftweb\UBI-IOT\ubi\8_2021-05-26_14-30-10.mp4"


cap = cv2.VideoCapture(ubi_path7)
...
while True:
    ...
    for (objectID, bbox) in objects.items():
        ...
        faces_rects = detector(gray, 0)
    
        new_rects = []
    
        for faceRect in faces_rects:
            (xx, yy, ww, hh) = face_utils.rect_to_bb(faceRect)
            if y<0:
                print("a")
                continue
            new_rects.append((xx, yy, xx + ww, yy + hh))
    
            input_im = img[yy:yy+hh, xx:xx+ww].copy()
